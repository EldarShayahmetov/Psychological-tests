...
begin
 ...
 begin
  ...
  begin
   ...
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('L'));
   // активировать запрос
   ADOQParamRes.Active := True;
   ...
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(L)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
    if ParamCount > 0 then
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('F'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(F)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('K'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(K)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Hs'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(Hs)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('D'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(D)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Hy'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(Hy)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Pd'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(Pd)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Pa'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(Pa)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Pt'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(Pt)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Sc'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(Sc)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
  ...
  begin
   ...
   ADOQParamRes.SQL.Clear;
   // найти номер соответствующего параметра результатов
   ADOQParamRes.SQL.Add('SELECT * FROM ParamResult WHERE Parametr = '+QuotedStr('Ma'));
   // активировать запрос
   ADOQParamRes.Active := True;
   // считать код параметра
   Code_Param := ADOQParamRes.FieldByName('ID_ParamResult').AsInteger;
   ...
   ADOQRes.SQL.Clear;
   // записать в результаты тестирования номера эксперимента, параметра результата, значение результата
   ADOQRes.SQL.Add('INSERT INTO Result (ID_Testing, ID_ParamResult, Value_Result)VALUES('+IntToStr(ID_Testing)+' ,'+IntToStr(Code_Param)+', '+IntToStr(Ma)+')');
   // выполнить запрос
   ADOQRes.ExecSQL;
  end;
